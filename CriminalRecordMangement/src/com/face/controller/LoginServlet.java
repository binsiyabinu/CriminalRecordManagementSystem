...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if((regbo.getOption()).equals("Jailer"))
			{
			...
			else if((regbo.getOption()).equals("Police"))
			{
			...
			else if((regbo.getOption()).equals("CBI"))
			{
			...
			else if((regbo.getOption()).equals("Admin"))
			{
			...
			else if((regbo.getOption()).equals("Judge"))
			{
				RequestDispatcher dispatcher = request.getRequestDispatcher("home5.jsp");
				 if (dispatcher != null) {
				       dispatcher.forward(request, response);
				 }
			}
